            ...
            <div className="space-y-6">
              <Card3D className="about-card">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xl md:text-2xl font-semibold mb-1 text-text-light dark:text-text-dark">Vishal Chaurasia</p>
            ...
            <p className="text-sm text-text-secondary-light/80 dark:text-text-secondary-dark/80 mt-2">
              ...
              <Card3D className="about-card">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xl md:text-2xl font-semibold mb-1 text-text-light dark:text-text-dark">Aman Bhogal</p>
